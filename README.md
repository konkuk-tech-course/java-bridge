...
- 다리 생성 ✅
  ...
  - 010010 -> UDUUDU로 변환 ✅
- 다리 건너는 사람 ✅
  - 위로 갈지 아래로 갈지 선택해야 함(U/D) ✅
  - 이동시 성공하면 O, 실패시 X로 표현 ✅
  - 다리를 끝까지 건너야만 게임 성공(종료) ✅
- 재시작 여부 ✅
  - 실패시 재시작 여부 물어봄(재시작/그냥 종료) ✅
  - 게임은 다리를 다 건너거나 Q를 누를때까지 지속된다.
  - 다리는 재사용 ✅
  - 시도 횟수 끝날 때 출력해야 함 ✅
- 예외 처리(IllegalArgumentException, IllegalStatementException) ✅
  - [ERROR] + 에러 내용 붙여야 함 ✅
- 테스트
  - 단위 테스트
  - 통합 테스트 ✅
